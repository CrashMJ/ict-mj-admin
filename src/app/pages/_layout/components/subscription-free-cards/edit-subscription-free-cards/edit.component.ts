...
@Component({
  selector: 'app-edit-subscription-free-cards',
...
export class EditComponent implements OnInit {
  ...
  constructor(
    ...
    private subscriptionFreeCardService: SubscriptionFreeCardService,
  ...
  ngOnInit(): void {
    ...
    this.subscriptionFreeCardService.getSltSubscriptionById(this.id).subscribe(
      (data: any) => {
  ...
  updateService(status: any, number_of_months: any) {
    ...
    this.subscriptionFreeCardService.editVodSubscription(status, number_of_months, this.id).subscribe(
      (data: any) => {
