...
export class EditFaqComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.tipInfoService.getTipInfoById(this.id).subscribe(
      (data: any) => {
        ...
        this.formGroup.get("question_en").setValue(this.tipInfoResponse.question_en);
        this.formGroup.get("answer_en").setValue(this.tipInfoResponse.answer_en);
      },
      (error) => {}
    );
  }
  ...
  save() {
    this.updateService({
      question_en: this.formGroup.get("question_en").value,
      answer_en: this.formGroup.get("answer_en").value,
    });
  }
