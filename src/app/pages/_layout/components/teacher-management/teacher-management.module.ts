...
import { TeacherModelComponent } from './teacher-model/teacher-model.component';
...
@NgModule({
  declarations: [TeacherManagementComponent, TeacherModelComponent, EditTeacherComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
