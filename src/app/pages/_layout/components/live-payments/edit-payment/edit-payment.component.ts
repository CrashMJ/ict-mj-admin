...
export class EditLivePaymentComponent implements OnInit {
  model: any;
  ...
  ngOnInit(): void {
    ...
    this.livePaymentService.getPaymentById(this.id).subscribe(
      (data: any) => {
  ...
  updateService(formData: any) {
    ...
    this.livePaymentService.editPayment(formData, this.id).subscribe(
      (data: any) => {
